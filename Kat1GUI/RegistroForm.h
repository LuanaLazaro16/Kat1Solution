...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(126, 110);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(100, 179);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(126, 133);
			...
			this->labelTituloPlantas->Location = System::Drawing::Point(96, 33);
			this->labelTituloPlantas->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->labelTituloPlantas->Name = L"labelTituloPlantas";
			this->labelTituloPlantas->Size = System::Drawing::Size(89, 23);
			this->labelTituloPlantas->TabIndex = 23;
			this->labelTituloPlantas->Text = L"REGISTRO";
			this->labelTituloPlantas->Click += gcnew System::EventHandler(this, &RegistroForm::labelTituloPlantas_Click);
			// 
			// RegistroForm
			// 
			...
			this->Controls->Add(this->labelTituloPlantas);
